...
void create(string *string_dest, char *chaine_src){
    ...
    string_dest->str = malloc(taille*sizeof(char));
    strcpy(string_dest->str, chaine_src);
    //printf("%c\n", (string_dest->str)[taille -1]);
    (string_dest->str)[taille -1] = '\0';
    //printf("%c\n", (string_dest->str)[taille -1]);
...
void add(string *chaine_dest, char c){
    // ****** TODO *******
    chaine_dest->str = realloc(chaine_dest->str,(chaine_dest->N + 1)*sizeof(char));
