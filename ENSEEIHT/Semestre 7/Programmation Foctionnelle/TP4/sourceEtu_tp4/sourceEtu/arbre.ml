...
(* Tests Unitaires : retrait_arbre *)

let%test _ = 
let remove_1_arbre_sujet2 = retrait_arbre ['b';'a';'s'] arbre_sujet2 in
   not ( appartient_arbre ['b';'a';'s'] remove_1_arbre_sujet2)
   && appartient_arbre ['b';'a';'t'] remove_1_arbre_sujet2
   && appartient_arbre ['d';'e'] remove_1_arbre_sujet2
   && appartient_arbre ['l';'a'] remove_1_arbre_sujet2
   && appartient_arbre ['l';'a';'i'] remove_1_arbre_sujet2
   && appartient_arbre ['l';'a';'i';'d'] remove_1_arbre_sujet2
   && appartient_arbre ['l';'a';'i';'t'] remove_1_arbre_sujet2
   && appartient_arbre ['l';'a';'r';'d'] remove_1_arbre_sujet2
   && appartient_arbre ['l';'e'] remove_1_arbre_sujet2
   && appartient_arbre ['l';'e';'s'] remove_1_arbre_sujet2
   && appartient_arbre ['l';'o';'n';'g'] remove_1_arbre_sujet2

let%test _ = 
let remove_2_arbre_sujet2 = retrait_arbre ['l';'e';'s'] arbre_sujet2 in
   not ( appartient_arbre ['l';'e';'s'] remove_2_arbre_sujet2)
   && appartient_arbre ['b';'a';'t'] remove_2_arbre_sujet2
   && appartient_arbre ['b';'a';'s'] remove_2_arbre_sujet2
   && appartient_arbre ['d';'e'] remove_2_arbre_sujet2
   && appartient_arbre ['l';'a'] remove_2_arbre_sujet2
   && appartient_arbre ['l';'a';'i'] remove_2_arbre_sujet2
   && appartient_arbre ['l';'a';'i';'d'] remove_2_arbre_sujet2
   && appartient_arbre ['l';'a';'i';'t'] remove_2_arbre_sujet2
   && appartient_arbre ['l';'a';'r';'d'] remove_2_arbre_sujet2
   && appartient_arbre ['l';'e'] remove_2_arbre_sujet2
   && appartient_arbre ['l';'o';'n';'g'] remove_2_arbre_sujet2

let%test _ = 
let remove_3_arbre_sujet2 = retrait_arbre ['l';'o';'l'] arbre_sujet2 in
   not ( appartient_arbre ['l';'o';'l'] remove_3_arbre_sujet2)
   && appartient_arbre ['b';'a';'t'] remove_3_arbre_sujet2
   && appartient_arbre ['b';'a';'s'] remove_3_arbre_sujet2
   && appartient_arbre ['d';'e'] remove_3_arbre_sujet2
   && appartient_arbre ['l';'a'] remove_3_arbre_sujet2
   && appartient_arbre ['l';'a';'i'] remove_3_arbre_sujet2
   && appartient_arbre ['l';'a';'i';'d'] remove_3_arbre_sujet2
   && appartient_arbre ['l';'a';'i';'t'] remove_3_arbre_sujet2
   && appartient_arbre ['l';'a';'r';'d'] remove_3_arbre_sujet2
   && appartient_arbre ['l';'e'] remove_3_arbre_sujet2
   && appartient_arbre ['l';'e';'s'] remove_3_arbre_sujet2
   && appartient_arbre ['l';'o';'n';'g'] remove_3_arbre_sujet2

(******************************************************************************)
(*   fonction qui renvoie la liste des éléments dans l'ordre lexicographique  *)
(*   d'un arbre passé en paramètre                                            *)
(*   signature  : liste_elements : 'a arbre -> 'a liste                       *)
(*   paramètres : - un arbre n-aire                                           *)
(*   résultat   : la liste des éléments dans l'ordre lexicographique          *)
(******************************************************************************)
let rec list_elements (Noeud (b, lb))=
   match b, lb with
   | true, _ -> []
   | false, [] -> []
   | _, (e,sousArbre)::branches -> 
(List.map (fun l -> e::l) (list_elements sousArbre)) 
@ (list_elements (Noeud(b, branches)))

let rec parcours_arbre (Noeud (b, bs))=
   let parcours_branche (c, sa) =
      (List.map (fun q -> c::q) (parcours_arbre sa)) in
      let sous_dicos = List.map parcours_branche bs in
      (* sous_dicos : 'a list list list*)
      let sous_dico = List.flatten sous_dicos in 
      (* sous_dico : 'a list list*)
      if b then []::sous_dico else sous_dico

(******************************************************************************)
(*   fonction éliminant les braches inutiles d'un arbre n-aire                *)
(*   signature  : normalisation : 'a arbre -> 'a arbre                        *)
(*   paramètres : - un arbre n-aire                                           *)
(*   résultat   : l'arbre n-aire sans les branches inutiles                   *)
(******************************************************************************)

let normalisation arbre = 
