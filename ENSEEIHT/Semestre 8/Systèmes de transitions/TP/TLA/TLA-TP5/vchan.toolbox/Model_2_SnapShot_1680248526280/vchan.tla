...
SenderWriteNext1 == /\ SenderLive
                    ...
                    /\ Len(msg) = 0
                    /\ SenderState' = Idle
                    /\ UNCHANGED << Sent, Got, msg, SenderLive, ReceiverLive, ReceiverState, Buffer, NotifyWrite, ReceiverIT, NotifyRead, SenderIT >>
...
SenderWriteNext2 == /\ SenderLive
                    ...
                    /\ Len(msg) > 0
                    /\ SenderState' = Blocked
                    /\ UNCHANGED << Sent, Got, SenderLive, msg, ReceiverLive, ReceiverState, Buffer, NotifyWrite, ReceiverIT, NotifyRead, SenderIT >>
...
SenderClose == /\ SenderLive
               /\ SenderLive' = FALSE
               /\ UNCHANGED << Sent, Got, ReceiverLive, SenderState, ReceiverState, Buffer, msg, NotifyWrite, ReceiverIT, NotifyRead, SenderIT >>


\* Receiver abruptly becomes dead. It sends an IT to sender on dying.
ReceiverClose == /\ ReceiverLive
                 /\ ReceiverLive' = FALSE
                 /\ UNCHANGED << Sent, Got, SenderLive, SenderState, ReceiverState, Buffer, msg, NotifyWrite, ReceiverIT, NotifyRead, SenderIT >>
