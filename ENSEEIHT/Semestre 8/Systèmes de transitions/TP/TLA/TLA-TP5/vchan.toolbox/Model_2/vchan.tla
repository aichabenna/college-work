...
SenderITspurious == ~SenderIT /\ SenderIT' = TRUE /\ UNCHANGED << Sent, Got, SenderLive, ReceiverLive, SenderState, ReceiverState, Buffer, msg, NotifyWrite, ReceiverIT, NotifyRead >>
\* A ReceiverIT spuriously appears.
ReceiverITspurious == ~ReceiverIT /\ ReceiverIT' = TRUE /\ UNCHANGED << Sent, Got, SenderLive, ReceiverLive, SenderState, ReceiverState, Buffer, msg, NotifyWrite, SenderIT, NotifyRead >>
...
Next == \/ SenderNext \/ ReceiverNext
        ...
        \/ SenderITspurious \/ ReceiverITspurious
