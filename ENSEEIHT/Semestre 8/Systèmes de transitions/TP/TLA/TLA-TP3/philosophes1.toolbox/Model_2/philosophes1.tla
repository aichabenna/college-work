...
(* Philosophes. Version en utilisant les fourchettes avec ordre. *)
...
TypeInvariant == [](etat \in [ Philos -> { Hungry, Thinking, Eating }] /\ etatFourchettes \in [Philos -> Nat])
...
Fairness == \A i \in Philos:
                /\ SF_<<etat,etatFourchettes>> (mange(i))
