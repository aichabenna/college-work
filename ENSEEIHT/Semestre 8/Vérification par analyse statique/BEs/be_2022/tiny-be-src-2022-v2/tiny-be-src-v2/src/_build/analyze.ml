...
module Dom : Relational.Domain = NonRelational.MakeRelational (Congruences)  
(* module Dom : Relational.Domain = NonRelational.MakeRelational (Intervals) *)
(* module Dom : Relational.Domain = NonRelational.MakeRelational (ProduitCongruencesIntervalles) *)
